...
public:
    ...
    // Progress callback type: (iter, precision, percent 0..100)
    typedef void (*TNM_ProgressCallback)(int, double, int);
...
protected:
    ...
    TNM_ProgressCallback progressCallback; // progress callback pointer
/*========================================================================================
    I-O methods.
  ========================================================================================*/
public:
    ...
    void              SetProgressCallback(TNM_ProgressCallback cb) { progressCallback = cb; }
...
/*========================================================================================
  ...
  ========================================================================================*/
public:
    inline floatType   GetConvIndicator() const { return convIndicator; }
...
public:
	...
	virtual int       Build(const string& inFile, const string& outFileName, MATINFORMAT, const string& dbConnStr);
	virtual int       Build(const string& inFile, const string& outFileName, MATINFORMAT, const string& dbConnStr, const string& networkTableName, const string& odTableName);
	...
	virtual void      WritePG(const string& dbConnStr, const string& networkTableName = "", const string& scenarioPrefix = ""); //export results to PostgreSQL database
...
TNM_EXT_CLASS void TNM_ResetTouchedTables();
TNM_EXT_CLASS void TNM_AppendTouchedTable(const string& qname);
TNM_EXT_CLASS const string& TNM_GetTouchedTables();
