...
/*==============================================================================================
  ...
  =============================================================================================*/
	...
	int                  BuildPostgreSQL(bool loadod = true, const TNM_LINKTYPE tt = BPRLK, const string& dbConnStr = "", const string& networkTableName = "road_way", const string& odTableName = "other_od"); //reading from PostgreSQL database. 
	...
	const string&        GetLastErrorDetail() const;
...
public:
	...
	bool                 InitialSubNet4(int sptreeLen = 0, bool createpath = false); // perform the ALL - OR - NOTHING assignment using an one - to - one shortest path algorithm; false if any demanded OD is unreachable

	void                 RecordUnreachableOD(int originId, int destId);
